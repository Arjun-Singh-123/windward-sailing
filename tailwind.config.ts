  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        light: "var(--light)",
        dark: "var(--dark)",
        lightPrimary: "var(--light_primary)",
        lightSecondary: "var(--light_secondary)",
        lightSuccess: "var(--light_success)",
        lightDanger: "var(--light_danger)",
        lightWarning: "var(--light_warning)",
        lightInfo: "var(--light_info)",
        lightLight: "var(--light_light)",
        lightDark: "var(--light_dark)",
