    ...
    <footer className="relative py-8 text-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://dev.windwardsailingclub.com/img/Sections/footer-bg.jpg")',
          zIndex: -2, // Ensure the image stays behind the gradient
        }}
      />
      ...
      <div className="  mx-auto px-4 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8  right-50">
          <Link href="/" className="flex items-center space-x-2 mb-4 md:mb-0">
            <img
              src="/images/logoo.png"
              alt="Windward Sailing Club"
          ...
          <div>
            <Link href="/" className="flex items-center space-x-2 mb-4">
              {/* Uncomment if you want to include the logo */}
              {/* <img
                src="https://dev.windwardsailingclub.com/img/Sections/boat-graphic.png"
                alt="Windward Sailing Club"
                className="h-12 w-auto"
          ...
          {/* Uncomment if you want to include the newsletter section */}
          {/* <div>
            <h3 className="text-lg font-bold mb-4">Newsletter</h3>
            <p className="mb-2">
              Stay updated with our latest news and offers!
