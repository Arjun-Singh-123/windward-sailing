...
export const stats = [
  ...
  { emoji: "🚢", value: 200, label: "YACHTS", bgColor: "bg-red-200" },
  // { emoji: "🏴", value: 50, label: "COUNTRIES", bgColor: "bg-purple-200" },
];

export const aboutContent = [
  {
    title: "Sailing the “Windward” Way",
    description:
  ...
  {
    title: "Your Cruise — Your Boat",
    description:
      "Upon boarding, you tailor your charter to fit your particular needs. Snorkeling, swimming and relaxing in Catalina are only a few ideas. You can also utilize Windward’s vessels to entertain and relax while sailing off the coast. Entertaining business clients, celebrating special occasions, or sailing around the harbors and dining at one of the many restaurants which provide guest docking facilities, are leisure activities many members enjoy.\n\nOur focus at Windward has always been to offer deluxe equipped boats. Each vessel is equipped, not only with all required safety gear, but with many of the amenities you would have aboard if it were you own boat. At a minimum, most vessels in Windward’s fleet have inboard engines, VHF radio, AM/FM stereos, boom vangs, knotmeters, compasses, cockpit seat cushions, dishes and silverware.",
  },
  {
    title: "Get Involved With Sailing",
    description:
      "On Windward’s yachts, you are the captain. Successful completion of our thorough, private and individualized instructional program, and/or on-the-water certification ride, entitles you to utilize Windward’s tastefully appointed vessels as if they were your own. You and your guests will appreciate the attention to detail our maintenance crew gives each vessel. The package we offer are clean, beautifully appointed and meet full safety requirements. At trips end, just secure the boat, sail covers/lines — set up your property and belongings, because the rest is up to us in making your leisure time most enjoyable and memorable!",
  },
  {
    title: "Our Goals",
    description:
